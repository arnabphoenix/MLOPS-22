...
X_train1, X_test1, y_train1, y_test1 = train_test_split(data, digits.target, test_size=0.20, random_state=random_state)
...
def train(clf_name,random_state):
    ...
    f1_scores = f1_score(y_test1.reshape(-1,1), ypred.reshape(-1,1), average='macro')
    a = accuracy_score(y_test1.reshape(-1,1), ypred.reshape(-1,1))
    print("test accuracy: ",a)
    print("\ntest macro-f1: ",f1_scores)
